package RDF::LinkedData::NLQuestion::Query;
...
RDF::LinkedData::NLQuestion::Query - Perl extension for representing the SPARQL query.

=head1 SYNOPSIS

use RDF::LinkedData::NLQuestion::Query;

my $query = RDF::LinkedData::NLQuestion::Query->new(
    'verbose' => 0,
    'docId' => $docId,
...
=item C<docId>: identifier of the natural language question

=item C<verbose>: specification of the verbose

=item C<language>: language of the natural language question

=item C<queryString>: the generated string corresponding to the SPARQL query

=item C<queryXMLString>: the generated XML string corresponding to the SPARQL query

=item C<queryAnswers>: the list of answers correspong to the query

=item C<selectPart>: array containing the information related to the select part of the query

=item C<wherePart>: array containing the information related to the where part of the query

=item C<aggregation>: structure recording the presence of aggregation operators

=item C<conjunction>: boolean indicated if the semantic entities are in conjunction

=item C<sentences>: sentences of the natural language question

=item C<negation>: structure recording the negated semantic entities

=item C<varPrefix>: prefix of the SPARQL variable

=item C<variableCounter>: counter of the variables (mainly used to define new variable in the query)

=item C<variableSet>: Set of the variables defined in the query

=item C<union>: structure recording the semantic entities on which the union operator is applied

=item C<semanticCorrespondance>: structure containing the semantic correspondance and the rewriting rules

=item C<questionTopic>: semantic type referring to the question topic

=item C<semFeaturesIndex>: index of the semantic types

=item C<sortedSemanticUnits>: sorted array of the semantic entities of the natural language question

=item C<config>: structure containing the configuration of the converter
...
Documentation of the module C<RDF::LinkedData::NLQuestion>
